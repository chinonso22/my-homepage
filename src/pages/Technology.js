...
function Technology() {
  return (
    ...
    <div class="isslsolutionflex flex2">
    <div class="isslsolutiontext">
        ...
        <div class="isslsolutionbody">
            Lörem ipsum nyst prose judyssade, beligen. Atest laved prosamma fast intrangen: dådat. Ufod diligt kase saskap. Lykrodir etenade. 
        </div>

        <div class="mybuttons">
            <input type="button" value="SCHEDULE A CALL" class="contactbtn button1 thered"/>
            <input type="button" value="EMAIL US" class="contactbtn button1 thrnorm"/>
        </div>
    </div>
...
<div class="isslsolutionscontainer pb20">
     
     
<div class="twosideintdiv rvs">
    <div class="sideofimage">
    <img src={require("../images/Group 84.png")}></img> 
     

    </div>
    <div class="sideoftexting">
        <div class="splitsideheaders">
            Corporate Banking
         </div>
         <div class="splitsidebody">
            We understand the unique banking needs of your corporate clients and we are committed to providing solutions that helps provide a competitive and flexible banking service. we provide solutions that;

            <div class="gtstartedlist">
                <div class="listcon">
                    <div class="listribbon">
                        
                    <img src={require("../images/vve.svg")}></img> 

                    </div>
                    <div class="listcontent">Anywhere, anytime and any device customer onboarding capability in a matter of minutes</div>
                </div>
                <div class="listcon">
                    <div class="listribbon">
                    ...
                    <div class="listcontent">Reducing customer onboarding time</div>
                </div>
                <div class="listcon">
                    <div class="listribbon">
                    ...
                    <div class="listcontent">Reduce the need for customers visits</div>
                </div>
                <div class="listcon">
                    <div class="listribbon">
                    <img src={require("../images/vve.svg")}></img> 
                    ...
                    <div class="listcontent">Cost savings and operational efficiency through fully automated end-to-end processes</div>
                </div>
                ...
                <div class="listcon">
                    ...
                    <div class="listcontent">Enhanced regulatory compliance</div>
                </div>
                ...
                <div class="listcon">
                    ...
                    <div class="listcontent">Reduced KYC due diligence time</div>
                </div>
               
            </div>
             <div class="requestdet">
                <input type="button" value="Get Started" class="contactbtn button1 thered"/>
             </div>
         </div>
    </div>
</div>
...
<div class="twosideintdiv">
<div class="sideofimage">
<img src={require("../images/Group 86.png")}></img> 
...
<div class="sideoftexting">
    <div class="splitsideheaders">
     ...
     <div class="splitsidebody">
        We understand the need for mid-size corporate businesses to have the right kind of liability products and services that cater to their unique banking needs. Our Business Banking service is designed to help your business to steadily grow and thrive.  we provide solutions that;
...
<div class="twosideintdiv rvs">
<div class="sideofimage">
<img src={require("../images/Group 94.png")}></img> 
...
<div class="productsol">
      <p class="productsolution">
        Our Product Solutions
      </p>

      <p class="solutionbody">
        Whether you are just starting up or looking to grow your business, we have the product solution that works just right for you
      </p>
...
<svg width="88" height="91" viewBox="0 0 88 91" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="25.553" cy="24.8353" rx="25.4836" ry="24.5003" fill="#3A3A85" fill-opacity="0.15"/>
    <path d="M37.2201 81H20.5534C18.7853 81 17.0896 80.2976 15.8393 79.0474C14.5891 77.7971 13.8867 76.1014 13.8867 74.3333V27.6667C13.8867 25.8986 14.5891 24.2029 15.8393 22.9526C17.0896 21.7024 18.7853 21 20.5534 21H73.8867C75.6548 21 77.3505 21.7024 78.6008 22.9526C79.851 24.2029 80.5534 25.8986 80.5534 27.6667V47.6667" stroke="#3A3A85" stroke-width="5.64586" stroke-linecap="round"/>
    <path d="M43.8867 27.7L43.9201 27.6633M47.2201 81V65.5367C47.2201 63.8367 47.5534 62.2067 48.1667 60.6933L47.2201 81ZM80.5534 81V70.3833V81ZM54.6267 53.45C57.4421 51.8281 60.6376 50.9826 63.8867 51C71.4867 51 77.8967 55.4333 79.9034 61.5L54.6267 53.45ZM57.2201 84.3333V77.0767V84.3333ZM70.5534 84.3333V67.1767C70.5534 63.7667 67.5701 61 63.8867 61C60.2034 61 57.2201 63.7667 57.2201 67.1767V69.8233L70.5534 84.3333ZM13.8867 34.3333H80.5534H13.8867ZM23.8867 27.7L23.9201 27.6633L23.8867 27.7ZM33.8867 27.7L33.9201 27.6633L33.8867 27.7Z" stroke="#3A3A85" stroke-width="5.64586" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
...
<svg width="81" height="80" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12.0518 31.1111H69.8295V35.5555H12.0518V31.1111Z" fill="#3A3A85"/>
    <path d="M74.2297 64.4443H7.56304C6.97367 64.4443 6.40844 64.6785 5.99169 65.0952C5.57495 65.512 5.34082 66.0772 5.34082 66.6666C5.34082 67.2559 5.57495 67.8212 5.99169 68.2379C6.40844 68.6547 6.97367 68.8888 7.56304 68.8888H74.2297C74.8191 68.8888 75.3843 68.6547 75.8011 68.2379C76.2178 67.8212 76.4519 67.2559 76.4519 66.6666C76.4519 66.0772 76.2178 65.512 75.8011 65.0952C75.3843 64.6785 74.8191 64.4443 74.2297 64.4443Z" fill="#3A3A85"/>
    <path d="M50.1188 25.7334H57.2521L42.341 17.1557C42.0707 16.9996 41.7642 16.9175 41.4521 16.9175C41.14 16.9175 40.8335 16.9996 40.5632 17.1557L25.6299 25.7334H32.7632L41.4299 20.7557L50.1188 25.7334Z" fill="#3A3A85"/>
    </g>
    <defs>
    <clipPath id="clip0_1930_1944">
    <rect width="80" height="80" fill="white" transform="translate(0.896484)"/>
    </clipPath>
    </defs>
    </svg>
...
<svg width="88" height="95" viewBox="0 0 88 95" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="productsol">
        ...
        <div class="solutionbody">
            Some of the brands we have worked with. It was a pleasure to work with them
        </div>
          ...
          <div class="productdiv men">
              ...
              <div class="product">
                  <div class="prodimg">
                  <img src={require("../images/Candour-Crest-Africa-Logo-Coloured-copy.png")}></img> 
              ...
              <div class="product">
                  ...
                  <img src={require("../images/Crystal-Logo.png")}></img>  
              ...
              <div class="product">
                  <div class="prodimg">
                  <img src={require("../images/logo (1).png")}></img> 
              ...
              <div class="product">
                <div class="prodimg">
                <img src={require("../images/NSL-Logo-.png")}></img> 
                </div>
